...
# bulk_nr_leaf_area column already exist, ready to be updated according to remarks regarding missing leaves at scanning 
...
# histogram for leaf area distribution trait leaves (mean area per leaf)
ggplot(
  data |> filter(proj_2025 == "Traits"),
  aes(x = wet_mass_g)
) +
...
NEED TO SCALE BY BULK NR LEAVES AT THIS STAGE, ADD COLOUR FOR EACH INDIVIDUAL PLANT
...
dry mass divided by wet mass - need to remove outliers at earlier stages first.

should plot we mass against dry mass , should give a relatively straight line
